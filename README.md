![Unit Tests](https://github.com/arithmic/eigensdk-go/actions/workflows/unit-tests.yml/badge.svg)
![Linter](https://github.com/arithmic/eigensdk-go/actions/workflows/golangci-lint.yml/badge.svg)
![Go Coverage](https://github.com/arithmic/eigensdk-go/wiki/coverage.svg)
[![Go Report Card](https://goreportcard.com/badge/github.com/arithmic/eigensdk-go)](https://goreportcard.com/report/github.com/arithmic/eigensdk-go)
...
```
go get github.com/arithmic/eigensdk-go
```
...
```
git clone https://github.com/arithmic/eigensdk-go.git
```
