...
// Source: github.com/arithmic/eigensdk-go/signer (interfaces: Signer)
//
// Generated by this command:
//
//	mockgen -destination=./mocks/signer.go -package=mocks github.com/arithmic/eigensdk-go/signer Signer
//
